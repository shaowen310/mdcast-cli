...
# (sibling of this package). The list is loaded at runtime and is NEVER
...
DEFAULT_DECORATIVE_KEYWORDS_FILE = (
    Path(__file__).resolve().parent / 'references' / 'decorative_keywords.txt'
)
...
def convert(input_pptx: str, output_md: str | None = None,
    ...
    asset_dir : str | Path | None
        ...
        images. Created if missing; old contents are removed. If None,
    ...
    decorative_keywords : list[str] | str | None
        ...
        * ``None`` (default) → load keywords from the package's
